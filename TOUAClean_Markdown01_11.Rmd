...
i = 2
while (i < 18) {
  print(paste("Test de Shapiro entre les données", names(toua_no_out[i])))
...
#}
  ...
  print(paste("p-value = ",t.test(toua_no_out$Mg_aCo2, toua_no_out$Mg_eCo2, paired = TRUE)$p.value))
  
  print("Test de Student entre les données Mn_aCo2 et Mn_eCo2")
  print(paste("p-value = ",t.test(toua_no_out$Mn_aCo2, toua_no_out$Mn_eCo2, paired = TRUE)$p.value))
  
  print("Test de Student entre les données Zn_aCo2 et Zn_eCo2")
  print(paste("p-value = ",t.test(toua_no_out$Zn_aCo2, toua_no_out$Zn_eCo2, paired = TRUE)$p.value))
  
  print("Test de Student entre les données C_aCo2 et C_eCo2")
  print(paste("p-value = ",t.test(toua_no_out$C_aCo2, toua_no_out$C_eCo2, paired = TRUE)$p.value))
  
  print("Test de Student entre les données N_aCo2 et N_eCo2")
  print(paste("p-value = ",t.test(toua_no_out$N_aCo2, toua_no_out$N_eCo2, paired = TRUE)$p.value))
